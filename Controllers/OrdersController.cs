...
using assignment2WebApp.Data;
using assignment2WebApp.Models;
...
namespace assignment2WebApp.Controllers
{
    public class OrdersController : Controller
    {
        ...
        // GET: Orders
        public async Task<IActionResult> Index(int? pageNumber, string sortOrder, int? itemsPerPage)
        {
            
            ViewBag.SortOrder = sortOrder;
            var northwindContext = _context.Orders.Include(o => o.Customer).Include(o => o.ShipViaNavigation);
            return View(await PaginatedList<Order>.CreateAsync(northwindContext.AsNoTracking(), pageNumber ?? 1, itemsPerPage ?? 5));
        }
